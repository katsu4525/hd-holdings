...
switch ($err_code) {
  case 0:
    $err_str = <<< "HTML"
      <h2>パスワード再設定用メールを送信しました。</h2>
      <p>入力いただいたメールアドレス宛にパスワード再設定用URLを送信しました。</p>
      <p>パスワード再設定用URLよりパスワードの再設定をお願いいたします。</p>
    HTML;
    break;
  case 100:
    $err_str = <<< "HTML"
  ...
  default:
    ...
    break;
  // case 0:
  //   $err_str = "入力していただいたメールアドレスに変更方法を送信いたしました。";
  //   break;
  // case 100:
  //   $err_str = "エラーが発生しました。<br>ログイン画面からやり直してください。";
  //   break;
  // case 110:
  //   $err_str = "管理者にお問い合わせください。";
  //   break;
  // default:
  //   $err_str = "エラーが発生しました。<br>ログイン画面からやり直してください。";
  //   break;
